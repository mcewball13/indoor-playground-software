import FullCalendar, { DateSelectArg, EventClickArg, EventDropArg } from '@fullcalendar/react/dist'; // => request placed at the top
...
//
import { useState, useRef, useEffect } from 'react/ts5.0';
// @mui
