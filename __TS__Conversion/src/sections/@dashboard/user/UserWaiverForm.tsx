...
export default function UserWaiverForm({
  isEdit,
  currentUser,
  isOpen,
  onOpen,
  ...
  return (
    <>
          ...
          <Grid container item xs={12} md={8} gap={3}>
            <Grid item xs={12}>
              <Card sx={{ p: 3 }}>
                ...
                >
                  <RHFTextFieldLoading
                    isLoading={emailExistsLoading}
                    name="email"
                    label="Email Address"
                  />
                  <RHFTextField
                    disabled={emailExistsLoading}
                  ...
                  <TableContainer>
                    <Table>
                      <TableBody>
                        {minors.map((minor, i) => (
                          <TableRow
                            key={`${minor.minorFirstName}_${i}`}
                            hover
                            ref={addedMinorScrollRef}
                          >
                            <TableCell>
                            ...
                            <TableCell>
                              <Typography variant="body1">
                                {formatDate(minor.minorBirthday)}
                              </Typography>
                            </TableCell>
      ...
      <DialogAnimate
        ...
        onClose={handleCustomerExistsCloseModal}
      >
